...
// 1.3.1.3 sha224_hash
/**
 * sha224 - compute SHA-224 hash of input
 * @param {string | Uint8Array} msg - input message (string assumed UTF-8)
 * @returns {string} hex digest (56 hex chars)
 */
function sha224_hash(msg) {
	...
	if (typeof msg === 'string') {
		bytes = new TextEncoder().encode(msg);
	...
	return toHex32(H[0]) + toHex32(H[1]) + toHex32(H[2]) + toHex32(H[3]) + toHex32(H[4]) + toHex32(H[5]) + toHex32(H[6]);
}
